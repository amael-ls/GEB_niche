...
\noindent \textbf{Main conclusions} Spatial and size-induced variations in tree growth and mortality does not explain range limits and are not enough to understand tree dynamics. We propose that phenomena perceived mostly at the metapopulation scale should also be considered. \\ % 38 words
