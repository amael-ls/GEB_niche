...
% \usepackage[normalem]{ulem} % Barrer text, command = \sout{text}
...
\title{Niche theory and tree distribution mismatch when accounting for stand structure, climate, and competition}
\author{}
...
\input{appendices/app_calc_R0}
\input{appendices/app_purves2009}
\input{appendices/app_database}
% \input{appendices/app_glmm}
% \input{appendices/app_maps}
% \input{appendices/app_randomForest}
% \input{appendices/app_confInt}
